...
def test_projects_strategy_process(projects_data):
    ...
    assert processed == [{'jira_id': '10200', 'uuid': '10200', 'key': 'SM2', 'name': 'SOS MNT 2025', 'projectTypeKey': 'software', 'simplified': True, 'start_date_project': None, 'end_date_project': None}, {'jira_id': '10202', 'uuid': '10202', 'key': 'SE', 'name': 'SOS Edital', 'projectTypeKey': 'software', 'simplified': True, 'start_date_project': None, 'end_date_project': None}]

def test_projects_strategy_save_projects_success(db):
    processed = [{'jira_id': '10200', 'uuid': '10200', 'key': 'SM2', 'name': 'SOS MNT 2025', 'projectTypeKey': 'software', 'simplified': True, 'start_date_project': None, 'end_date_project': None}, {'jira_id': '10202', 'uuid': '10202', 'key': 'SE', 'name': 'SOS Edital', 'projectTypeKey': 'software', 'simplified': True, 'start_date_project': None, 'end_date_project': None}]
