# Generated by Django 4.2.16 on 2025-10-09 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custo_do_projeto_atual_rs', models.DecimalField(decimal_places=2, help_text='Somatória das horas dos devs trabalhadas * valor hora respectivo', max_digits=15)),
                ('total_horas_acumuladas', models.DecimalField(decimal_places=2, help_text='Total de horas já gastas em desenvolvimento', max_digits=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dev', models.ForeignKey(help_text='Desenvolvedor que trabalhou na Issue', on_delete=django.db.models.deletion.PROTECT, to='core.dimdev', verbose_name='Desenvolvedor')),
            ...
            options={
                ...
                'db_table': 'fato_issue',
                'indexes': [models.Index(fields=['projeto', 'dev', 'data_criacao', 'intervalo_trabalho'], name='fato_issue_projeto_872e43_idx')],
            },
        ),
    ]
